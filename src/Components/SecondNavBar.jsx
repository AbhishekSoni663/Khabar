    ...
    <div>
      <nav className="navbar">
        <div className="container-fluid">
          <iframe
            className="clock float-end"
            src="https://free.timeanddate.com/clock/i8t0wlq6/n4603/fn6/fs16/fc9ff/tc000/ftb/bat1/bacfff/pa2/tt0/tw1/th1/ta1/tb4"
            frameborder="0"
            width="202"
            height="46"
          ></iframe>
          <marquee width="65%" direction="right">
            AAP leaders hold emergency meet fearing Kejriwal's arrest in Excise
            Policy case
          </marquee>
